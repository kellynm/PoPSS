...
#plot3 = plot3 + theme(axis.title=element_text(size=16, vjust=0,35,colour="white"),legend.text=element_text(size=12,colour="white"))
...
title = "Model Output"
theme = theme_set(theme_classic())
theme = theme_update(legend.position="top", legend.title=element_blank(),legend.spacing=unit(-0.5,"lines"), plot.background = element_rect(fill = "#3F3E3E", colour = NA), panel.background = element_rect(fill = "#3F3E3E", colour = NA), legend.background = element_rect(fill = "#3F3E3E"),panel.margin =unit(c(0,0,0,0),"null"), plot.margin =unit(c(0,0,0,0),"null"))
theme = theme_update(axis.text = element_text(size = 12, colour="white"), axis.ticks=element_blank(), plot.title = element_text(hjust = 0.5,colour="white", size =18), axis.line = element_line(colour="white"),axis.title=element_text(size=16, vjust=0,35,colour="white"),legend.text=element_text(size=12,colour="white"))
