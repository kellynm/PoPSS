#---------------------------------------------------------------------------------------------------------------
# Name:         SOD_aniso_clim_parallel.r
...
# Author:       Francesco Tonini, Chris Jones
# Email:        ftonini84@gmail.com, cjones1688@gmail.com 
# Created:      01/07/2015
# Modified      05/08/2017
...
suppressPackageStartupMessages(library(parallel))  #Allows for parallel computation
suppressPackageStartupMessages(library(doParallel))#Allows for parallel computation
suppressPackageStartupMessages(library(foreach))   #Runs Parallel for loops

##Define the main working directory based on the current script path
setwd("C:\\Users\\Chris\\Dropbox\\Projects\\APHIS\\BayOakCode")
...
totaltime = proc.time() - orignialtime
